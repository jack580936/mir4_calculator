          ...
          <div v-for="strategy in result_data_for_display" class="list-group list-group-flush col-12 col-md-4">
            ...
            <template v-for="material_name in strategy.method">
              <div class="list-group list-group-sm answer-img">
                <img v-if="material_name.value>0 && !['dark_steel', 'powder', 'money'].includes(material_name.name)" :src="getImageUrl(`${material_name.name}.png`)" :class="`list-group-item img-thumbnail ${strategy.class}`" alt="...">
                <img v-else-if="material_name.value>0 && ['dark_steel', 'powder', 'money'].includes(material_name.name)" :src="getImageUrl(`${material_name.name}.png`)" :class="`list-group-item img-thumbnail Uncommon`" alt="...">
        ...
        <div class="charge list-group list-group-flush col-12">
          ...
          <template v-for="(value,key) in {'dark_steel': '黑鐵','money':'銅幣'}">
            <div class="list-group create">
              <img v-if="manufacture_fee()[key]>0" :src="getImageUrl(`${key}.png`)" :class="`list-group-item img-thumbnail Uncommon`" alt="...">
