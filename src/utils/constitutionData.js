...
export const physicalDefense = [
    ...
    new Tier('Tier 11', [
        new Level(51, '藥草葉', 20, '靈芝', 20),
        new Level(52, '藥草葉', 30, '靈芝', 30),
        new Level(53, '藥草葉', 45, '靈芝', 45),
        new Level(54, '藥草葉', 67, '靈芝', 67),
        new Level(55, '藥草葉', 100, '靈芝', 100),
    ]),
    new Tier('Tier 12', [
...
export const hp = [
    new Tier('Tier 8', [
        new Level(36, '藥草葉', 4, '毒角片', 20),
        new Level(37, '藥草葉', 6, '毒角片', 20),
        new Level(38, '藥草葉', 9, '毒角片', 20),
        new Level(39, '藥草葉', 13, '毒角片', 20),
        new Level(40, '藥草葉', 19, '毒角片', 20),
    ], 'Epic'),
    new Tier('Tier 9', [
        new Level(41, '藥草葉', 10, '毒角片', 30),
        new Level(42, '藥草葉', 15, '毒角片', 30),
        new Level(43, '藥草葉', 22, '毒角片', 30),
        new Level(44, '藥草葉', 33, '毒角片', 30),
        new Level(45, '藥草葉', 49, '毒角片', 30),
    ], 'Epic'),
    new Tier('Tier 10', [
        new Level(46, '藥草葉', 20, '毒角片', 40),
        new Level(47, '藥草葉', 30, '毒角片', 40),
        new Level(48, '藥草葉', 45, '毒角片', 40),
        new Level(49, '藥草葉', 67, '毒角片', 40),
        new Level(50, '藥草葉', 100, '毒角片', 40),
    ], 'Epic'),
    new Tier('Tier 11', [
        new Level(51, '藥草葉', 20, '毒角片', 50),
        new Level(52, '藥草葉', 30, '毒角片', 50),
        new Level(53, '藥草葉', 45, '毒角片', 50),
        new Level(54, '藥草葉', 67, '毒角片', 50),
        new Level(55, '藥草葉', 100, '毒角片', 50),
    ], 'Epic'),
    new Tier('Tier 12', [
...
export const eva = [
    new Tier('Tier 8', [
        new Level(36, '靈芝', 4, '毒角片', 20),
        new Level(37, '靈芝', 6, '毒角片', 20),
        new Level(38, '靈芝', 9, '毒角片', 20),
        new Level(39, '靈芝', 13, '毒角片', 20),
        new Level(40, '靈芝', 19, '毒角片', 20),
    ], 'Epic'),
    new Tier('Tier 9', [
        new Level(41, '靈芝', 10, '毒角片', 30),
        new Level(42, '靈芝', 15, '毒角片', 30),
        new Level(43, '靈芝', 22, '毒角片', 30),
        new Level(44, '靈芝', 33, '毒角片', 30),
        new Level(45, '靈芝', 49, '毒角片', 30),
    ], 'Epic'),
    new Tier('Tier 10', [
        new Level(46, '靈芝', 20, '毒角片', 40),
        new Level(47, '靈芝', 30, '毒角片', 40),
        new Level(48, '靈芝', 45, '毒角片', 40),
        new Level(49, '靈芝', 67, '毒角片', 40),
        new Level(50, '靈芝', 100, '毒角片', 40),
    ], 'Epic'),
    new Tier('Tier 11', [
        new Level(51, '靈芝', 20, '毒角片', 50),
        new Level(52, '靈芝', 30, '毒角片', 50),
        new Level(53, '靈芝', 45, '毒角片', 50),
        new Level(54, '靈芝', 67, '毒角片', 50),
        new Level(55, '靈芝', 100, '毒角片', 50),
    ], 'Epic'),
    new Tier('Tier 12', [
...
export const attack = [
    new Tier('Tier 8', [
        new Level(36, '藥草根', 4, '百年果', 20),
        new Level(37, '藥草根', 6, '百年果', 20),
        new Level(38, '藥草根', 9, '百年果', 20),
        new Level(39, '藥草根', 13, '百年果', 20),
        new Level(40, '藥草根', 19, '百年果', 20),
    ], 'Epic'),
    new Tier('Tier 9', [
        new Level(41, '藥草根', 10, '百年果', 30),
        new Level(42, '藥草根', 15, '百年果', 30),
        new Level(43, '藥草根', 22, '百年果', 30),
        new Level(44, '藥草根', 33, '百年果', 30),
        new Level(45, '藥草根', 49, '百年果', 30),
    ], 'Epic'),
    new Tier('Tier 10', [
        new Level(46, '藥草根', 20, '百年果', 40),
        new Level(47, '藥草根', 30, '百年果', 40),
        new Level(48, '藥草根', 45, '百年果', 40),
        new Level(49, '藥草根', 67, '百年果', 40),
        new Level(50, '藥草根', 100, '百年果', 40),
    ], 'Epic'),
    new Tier('Tier 11', [
        new Level(51, '藥草根', 20, '百年果', 50),
        new Level(52, '藥草根', 30, '百年果', 50),
        new Level(53, '藥草根', 45, '百年果', 50),
        new Level(54, '藥草根', 67, '百年果', 50),
        new Level(55, '藥草根', 100, '百年果', 50),
    ], 'Epic'),
    new Tier('Tier 12', [
...
export const spellDefense = [
    new Tier('Tier 8', [
        new Level(36, '藥草葉', 4, '藥草根', 4),
        new Level(37, '藥草葉', 6, '藥草根', 6),
        new Level(38, '藥草葉', 9, '藥草根', 9),
        new Level(39, '藥草葉', 13, '藥草根', 13),
        new Level(40, '藥草葉', 19, '藥草根', 19),
    ], 'Epic'),
    new Tier('Tier 9', [
        new Level(41, '藥草葉', 10, '藥草根', 10),
        new Level(42, '藥草葉', 15, '藥草根', 15),
        new Level(43, '藥草葉', 22, '藥草根', 22),
        new Level(44, '藥草葉', 33, '藥草根', 33),
        new Level(45, '藥草葉', 49, '藥草根', 49),
    ]),
    new Tier('Tier 10', [
        new Level(46, '藥草葉', 20, '藥草根', 20),
        new Level(47, '藥草葉', 30, '藥草根', 30),
        new Level(48, '藥草葉', 45, '藥草根', 45),
        new Level(49, '藥草葉', 67, '藥草根', 67),
        new Level(50, '藥草葉', 100, '藥草根', 100),
    ], 'Epic'),
    new Tier('Tier 11', [
        new Level(51, '藥草葉', 20, '藥草根', 20),
        new Level(52, '藥草葉', 30, '藥草根', 30),
        new Level(53, '藥草葉', 45, '藥草根', 45),
        new Level(54, '藥草葉', 67, '藥草根', 67),
        new Level(55, '藥草葉', 100, '藥草根', 100),
    ]),
    new Tier('Tier 12', [
    ...
    new Tier('Tier 19', [
        ...
        new Level(95, '藥草葉', 30, '藥草根', 30),
    ], 'Legendary'),
];

export const mp = [
    new Tier('Tier 8', [
        new Level(36, '藥草葉', 4, '花幽飲', 20),
        new Level(37, '藥草葉', 6, '花幽飲', 20),
        new Level(38, '藥草葉', 9, '花幽飲', 20),
        new Level(39, '藥草葉', 13, '花幽飲', 20),
        new Level(40, '藥草葉', 19, '花幽飲', 20),
    ], 'Epic'),
    new Tier('Tier 9', [
        new Level(41, '藥草葉', 10, '花幽飲', 30),
        new Level(42, '藥草葉', 15, '花幽飲', 30),
        new Level(43, '藥草葉', 22, '花幽飲', 30),
        new Level(44, '藥草葉', 33, '花幽飲', 30),
        new Level(45, '藥草葉', 49, '花幽飲', 30),
    ], 'Epic'),
    new Tier('Tier 10', [
        new Level(46, '藥草葉', 20, '花幽飲', 40),
        new Level(47, '藥草葉', 30, '花幽飲', 40),
        new Level(48, '藥草葉', 45, '花幽飲', 40),
        new Level(49, '藥草葉', 67, '花幽飲', 40),
        new Level(50, '藥草葉', 100, '花幽飲', 40),
    ], 'Epic'),
    new Tier('Tier 11', [
        new Level(51, '藥草葉', 20, '花幽飲', 50),
        new Level(52, '藥草葉', 30, '花幽飲', 50),
        new Level(53, '藥草葉', 45, '花幽飲', 50),
        new Level(54, '藥草葉', 67, '花幽飲', 50),
        new Level(55, '藥草葉', 100, '花幽飲', 50),
    ], 'Epic'),
    new Tier('Tier 12', [
...
export const accuracy = [
    new Tier('Tier 8', [
        new Level(36, '靈芝', 4, '花幽飲', 20),
        new Level(37, '靈芝', 6, '花幽飲', 20),
        new Level(38, '靈芝', 9, '花幽飲', 20),
        new Level(39, '靈芝', 13, '花幽飲', 20),
        new Level(40, '靈芝', 19, '花幽飲', 20),
    ], 'Epic'),
    new Tier('Tier 9', [
        new Level(41, '靈芝', 10, '花幽飲', 30),
        new Level(42, '靈芝', 15, '花幽飲', 30),
        new Level(43, '靈芝', 22, '花幽飲', 30),
        new Level(44, '靈芝', 33, '花幽飲', 30),
        new Level(45, '靈芝', 49, '花幽飲', 30),
    ], 'Epic'),
    new Tier('Tier 10', [
        new Level(46, '靈芝', 20, '花幽飲', 40),
        new Level(47, '靈芝', 30, '花幽飲', 40),
        new Level(48, '靈芝', 45, '花幽飲', 40),
        new Level(49, '靈芝', 67, '花幽飲', 40),
        new Level(50, '靈芝', 100, '花幽飲', 40),
    ], 'Epic'),
    new Tier('Tier 11', [
        new Level(51, '靈芝', 20, '花幽飲', 50),
        new Level(52, '靈芝', 30, '花幽飲', 50),
        new Level(53, '靈芝', 45, '花幽飲', 50),
        new Level(54, '靈芝', 67, '花幽飲', 50),
        new Level(55, '靈芝', 100, '花幽飲', 50),
    ], 'Epic'),
    new Tier('Tier 12', [
